...
Fams <- get_table(.table_name = "Students", 
  ...
  select(StudentNumber
      ...
      ,EconomicDisadvantageDescription
      ,ECDCode
      ,ECDFlag
       ) %>%
...
Full_List <- left_join(Fams, schl_name, by = "SchoolNumber")
...
HardRec <- Full_List %>%
  ...
  select(StudentNumber, FirstName, LastName, AcademicYear, SchoolShortName, PhysicalStreet, FatherFullName, MotherFullName, PhoneStudentHome, ECDFlag, RegionDescription, RegionID)
...
LoEngage <- Full_List2 %>%
  ...
  select(StudentNumber, AcademicYear, SchoolShortName, FatherFullName, MotherFullName, PhoneStudentHome, ECDFlag, RegionDescription, RegionID)
